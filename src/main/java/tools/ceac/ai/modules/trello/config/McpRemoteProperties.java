...
/**
 * Runtime-side MCP exposure properties for the Trello module.
 */
...
public class McpRemoteProperties {
    ...
    public static class Auth {
        ...
        private String requiredScope = "trello:tools";
        private String resourceName = "Trello MCP";
        private List<String> scopesSupported = new ArrayList<>(List.of("trello:tools"));
