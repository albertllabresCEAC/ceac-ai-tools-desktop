package tools.ceac.ai.modules.campus.interfaces.oauth;
...
import tools.ceac.ai.modules.campus.config.McpRemoteProperties;
import tools.ceac.ai.modules.campus.config.McpUrlService;
