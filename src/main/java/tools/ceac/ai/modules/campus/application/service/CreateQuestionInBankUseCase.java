 ...
 * <ol>
 *   <li>GET {@code question/edit.php?cmid=â€¦} â†’ parse courseId, sesskey</li>
 ...
 * <ul>
 *   <li>{@code returnurl} â†’ {@code /question/edit.php?cmid={cmid}} (bank page, not quiz edit page)</li>
 *   <li>{@code appendqnumstring} â†’ {@code ""} (no quiz slot attachment)</li>
 * </ul>
 */
@Service
public class CreateQuestionInBankUseCase {
    ...
    public void execute(String cmid, String categoryValue,
        ...
        try {
            ...
            // Step 3 â€” POST the new question to the bank (returnurl points to bank page)
    ...
    private Map<String, String> buildParams(String cmid, String courseId,
        ...
        // Structural / hardcoded â€” bank context: returnurl points to question bank, no slot attachment
