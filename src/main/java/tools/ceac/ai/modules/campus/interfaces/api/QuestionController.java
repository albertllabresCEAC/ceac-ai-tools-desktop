...
import tools.ceac.ai.modules.campus.application.service.DeleteQuestionFromBankUseCase;
...
import tools.ceac.ai.modules.campus.interfaces.api.dto.QuizQuestionDetailResponse;
...
public class QuestionController {
    ...
    public QuizQuestionDetailResponse getQuestion(
            ...
            @Parameter(description = "ID del mÃ³dulo de quiz Moodle (cmid)", example = "302206")
                    ...
                    examples = @ExampleObject(value = """
                            {
                              ...
                              "answers": [
                                { "text": "OpciÃ³n A", "fraction": "1.0", "feedback": "" },
                                { "text": "OpciÃ³n B", "fraction": "-0.5", "feedback": "" },
                                { "text": "OpciÃ³n C", "fraction": "-0.5", "feedback": "" }
                              ],
                              "hints": []
                            }""")))
    ...
    public ResponseEntity<Void> deleteQuestionFromBank(
            ...
            @PathVariable String questionId,
            @Parameter(description = "ID del mÃ³dulo de quiz Moodle (cmid) que define el contexto del banco", example = "314207")
            @RequestParam String cmid) {
