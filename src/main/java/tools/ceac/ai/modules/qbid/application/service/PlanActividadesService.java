...
import tools.ceac.ai.modules.qbid.infrastructure.parser.PlanActividadesParser;
...
public class PlanActividadesService {
    ...
    public PlanActividadesService(QbidTransport http, QbidEndpointFactory urls, PlanActividadesParser parser) {
        this.http   = http;
        this.urls   = urls;
        this.parser = parser;
    }
