package tools.ceac.ai.mcp.outlook.mcp;

import tools.ceac.ai.mcp.outlook.model.AttachmentContent;
import tools.ceac.ai.mcp.outlook.model.AttachmentContentToolRequest;
import tools.ceac.ai.mcp.outlook.model.AttachmentInfo;
import tools.ceac.ai.mcp.outlook.model.AttachmentListToolRequest;
import tools.ceac.ai.mcp.outlook.model.AttachmentPayload;
import tools.ceac.ai.mcp.outlook.model.ComposeMode;
import tools.ceac.ai.mcp.outlook.model.CreateDraftRequest;
import tools.ceac.ai.mcp.outlook.model.ComposeMailToolRequest;
import tools.ceac.ai.mcp.outlook.model.DraftAttachmentToolRequest;
import tools.ceac.ai.mcp.outlook.model.DraftDispatchToolRequest;
import tools.ceac.ai.mcp.outlook.model.DraftDiscardToolRequest;
import tools.ceac.ai.mcp.outlook.model.FolderType;
import tools.ceac.ai.mcp.outlook.model.MailDraftResponse;
import tools.ceac.ai.mcp.outlook.model.MailMessage;
import tools.ceac.ai.mcp.outlook.model.McpSearchResult;
import tools.ceac.ai.mcp.outlook.model.MessageGetToolRequest;
import tools.ceac.ai.mcp.outlook.model.MessageListToolRequest;
import tools.ceac.ai.mcp.outlook.model.MessageQuery;
import tools.ceac.ai.mcp.outlook.model.MessageSearchToolRequest;
...
import tools.ceac.ai.mcp.outlook.model.UpdateDraftToolRequest;
import tools.ceac.ai.mcp.outlook.service.OutlookComException;
