...
import tools.ceac.ai.mcp.campus.domain.model.DeleteQuestionConfirmData;
import tools.ceac.ai.mcp.campus.domain.model.QuestionBankData;
import tools.ceac.ai.mcp.campus.infrastructure.campus.MoodleDeleteQuestionConfirmParser;
...
public class DeleteQuestionFromBankUseCase {
     ...
     * <p>Flow:
     * <ol>
     *   <li>GET {@code /question/edit.php?cmid={cmid}} → extract {@code sesskey}.</li>
     *   <li>POST {@code /question/bank/deletequestion/delete.php} with {@code q{id}=1} for each
     *       question → Moodle returns a confirmation page containing a {@code confirm} token.</li>
     *   <li>POST {@code /question/bank/deletequestion/delete.php} with {@code confirm} token
     *       → Moodle deletes and responds with HTTP 303.</li>
     * </ol>
     *
    ...
    public void execute(String cmid, List<String> questionIds) {
        ...
        try {
            // Step 1 — obtain sesskey from the question bank page
            ...
            // Step 2 — POST to trigger confirmation page and extract confirm token
            ...
            // Step 3 — POST with confirm token to execute the actual deletion (Moodle responds 303)
