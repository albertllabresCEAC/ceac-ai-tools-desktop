...
import tools.ceac.ai.mcp.campus.interfaces.api.dto.ConversationDetailResponse;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.ConversationMemberResponse;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.ConversationMessageResponse;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.ConversationResponse;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.MessageRecipientResponse;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.ReplyToMessageRequest;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.SendNewMessageRequest;
...
public class MessagesController {
    ...
    public List<ConversationResponse> conversations(
            ...
            @Parameter(description = "Máximo de conversaciones a devolver", example = "51")
    ...
    public ConversationDetailResponse conversationMessages(
            @Parameter(description = "ID de la conversación", example = "39618")
            @PathVariable String convId,
            @Parameter(description = "ID del usuario actual", example = "7281")
            @RequestParam String currentUserId,
            @Parameter(description = "Más recientes primero", example = "true")
            @RequestParam(defaultValue = "true") boolean newest,
            @Parameter(description = "Máximo de mensajes a devolver", example = "101")
