...
import tools.ceac.ai.mcp.campus.domain.model.QuizEditMetadata;
import tools.ceac.ai.mcp.campus.domain.model.QuizSlot;
 ...
 *     li.section
 *       div.content
 *         ul.section.img-text          &lt;-- iteramos aquí
 *           li.pagenumber#page-N       &lt;-- separador de página
...
public class MoodleQuizEditParser {
    ...
    public QuizStructure parse(String html, String cmid, String baseUrl) {
        ...
        for (Element item : slotsUl.children()) {
            ...
            // --- Max mark ---
            // <span class="instancemaxmark decimalplaces_2" title="Nota máxima">1,00</span>
            String maxMark = "";
