...
import tools.ceac.ai.mcp.campus.domain.model.GraderInfo;
 ...
 * <p>
 * Workflow: GET grader page → extract assignmentId → GET unused draft itemid
 * → build JSON form data → POST to {@code mod_assign_submit_grading_form}.
 * </p>
 */
@Service
