...
import tools.ceac.ai.mcp.campus.domain.model.QuizCommentData;
...
import tools.ceac.ai.mcp.campus.interfaces.api.dto.QuizAttemptAnswerOptionResponse;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.QuizAttemptQuestionResponse;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.QuizAttemptResponse;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.QuizAttemptReviewResponse;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.QuizCommentResponse;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.QuizConfigResponse;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.QuizOverrideSettingResponse;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.QuizQuestionCategoryResponse;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.QuizQuestionResultResponse;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.QuizReviewPhaseResponse;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.QuizSlotResponse;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.QuizStructureResponse;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.QuizUserOverrideResponse;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.DeleteQuizSlotResponse;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.SaveQuizCommentRequest;
import tools.ceac.ai.mcp.campus.interfaces.api.dto.SaveQuizUserOverrideRequest;
...
public class QuizController {
    ...
    public QuizConfigResponse quizConfig(
            @Parameter(description = "ID del módulo de quiz Moodle (cmid)", example = "314182")
    ...
    public QuizStructureResponse quizSlots(
            @Parameter(description = "ID del módulo de quiz Moodle (cmid)", example = "314207")
            @PathVariable String cmid) {
    ...
    public List<QuizAttemptResponse> results(
            @Parameter(description = "ID del módulo de quiz Moodle", example = "313877")
    ...
    public QuizCommentResponse quizComment(
            @Parameter(description = "ID del intento de quiz Moodle", example = "1394723")
            @PathVariable String attemptId,
            @Parameter(description = "Número de slot de la pregunta", example = "14")
    ...
    public ResponseEntity<Void> deleteUserOverride(
            @Parameter(description = "ID de la excepción de usuario", example = "571")
    ...
    public ResponseEntity<Void> saveUserOverride(
            @Parameter(description = "ID del módulo de quiz Moodle (cmid)", example = "314205")
            @PathVariable String cmid,
            @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @Content(
    ...
    private QuizReviewPhaseResponse toPhaseResponse(tools.ceac.ai.mcp.campus.domain.model.QuizReviewPhase p) {
