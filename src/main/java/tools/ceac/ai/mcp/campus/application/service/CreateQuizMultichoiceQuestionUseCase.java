 ...
 * <ol>
 *   <li>GET {@code question/edit.php?cmid=…} → parse courseId, sesskey, and available categories</li>
...
public class CreateQuizMultichoiceQuestionUseCase {
    ...
    private Map<String, String> buildParams(String cmid, String courseId,
        ...
        // Answers — format=1 (HTML) for new questions
