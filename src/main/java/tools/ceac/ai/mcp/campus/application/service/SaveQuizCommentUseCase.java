...
import tools.ceac.ai.mcp.campus.infrastructure.campus.MoodleQuizCommentParser;
 ...
 * <p>
 * Workflow: GET comment form → parse hidden fields (sesskey, usageId, sequencecheck, etc.)
 * → POST to {@code /mod/quiz/comment.php} with the provided mark and comment.
 * </p>
 */
@Service
