...
import com.alber.outlookdesktop.launcher.ClientMcpResourceResponse;
...
import com.alber.outlookdesktop.launcher.ManagedMcpKind;
import com.alber.outlookdesktop.launcher.QbidRuntimeService;
...
class CeacLauncherWindow {
    ...
    private void startOutlook() throws Exception {
        ...
        outlookContext = CompletableFuture.supplyAsync(() -> new SpringApplicationBuilder(OutlookDesktopComMcpApplication.class)
